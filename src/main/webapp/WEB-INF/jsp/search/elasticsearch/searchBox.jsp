   ...
   <div class="row" style="width: 100%;float: right;margin:0;">
       ...
       <form name="elasticSearchForm"  action="<%= rgdBase %>/rgdweb/elasticResults.html" id="elasticSearchForm" role="search" method="post">
           <%
    ...
    <div class="input-group">
       ...
       <div class="col-12 col-md-3">
               ...
               <small class="form-text text-muted"><a href="<%= rgdBase %>/rgdweb/generator/list.html" >Advanced Search (OLGA)</a></small>
