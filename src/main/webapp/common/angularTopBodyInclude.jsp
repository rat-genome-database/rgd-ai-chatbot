        ...
        <div class="modal-dialog modal-lg">
           <div class="modal-content" id="rgd-modal" >
                ...
                <div class="modal-header">
                    <table align="center">
                        <tr>
                            <td style="padding:20px;"><img src="<%= rgdBase %>/rgdweb/common/images/rgd_LOGO_blue_rgd.gif" border="0"/></td>
                        </tr>
                    </table>
                ...
                <div class="modal-body">
                    ...
                    <div style="display: table-cell; float:left; margin-right:10px;min-width: 90px"><a href="<%= rgdBase %>/rgdweb/my/account.html">Go to Message Center</a></div>
                    </div>
                    ...
                    <div class="modal-content" >
                        ...
                        <div class="modal-body">
                            ...
                            <table width="90%" align="center" border="0">
                                <tr>
                                    <td align="center" ng-if="oKey==1"><img src="<%= rgdBase %>/rgdweb/common/images/functionalAnnotation.png" border="0"  style="cursor:pointer;padding:5px; margin-right:0px;margin-bottom:5px; border:1px solid black;" ng-click="rgd.toolSubmit('ga')"/></td>
                                    <td align="center" ng-if="oKey==1"> <img src="<%= rgdBase %>/rgdweb/common/images/annotDist.PNG" border="0" style="cursor:pointer;padding:5px; margin-bottom:5px; border:1px solid black;" ng-click="rgd.toolSubmit('distribution')"/></td>
                                    <td align="center" ng-if="oKey==1 && (speciesTypeKey==1 || speciesTypeKey==2 || speciesTypeKey==3 || speciesTypeKey==6 || speciesTypeKey==9 || speciesTypeKey==13)"><img src="<%= rgdBase %>/rgdweb/common/images/variantVisualizer.png" border="0"  style="cursor:pointer;padding:5px; margin-right:0px;margin-bottom:5px; border:1px solid black;"  ng-click="rgd.toolSubmit('vv')"/></td>
                                </tr>
                                <tr>
                                ...
                                <tr><td>&nbsp;</td></tr>
                                <tr>
                                    <td align="center" ng-if="oKey==1"><img src="<%= rgdBase %>/rgdweb/common/images/interviewer.png" border="0" style="cursor:pointer;padding:5px; margin-right:0px; border:1px solid black;" ng-click="rgd.toolSubmit('interviewer')"/></td>
                                    <td align="center" ng-if="oKey==1 && (speciesTypeKey==1 || speciesTypeKey==3 || speciesTypeKey==2 || speciesTypeKey==5 || speciesTypeKey==6 || speciesTypeKey==9)"> <img src="<%= rgdBase %>/rgdweb/common/images/gviewer.png" border="0" style="cursor:pointer;padding:5px; margin-bottom:5px; border:1px solid black;" ng-click="rgd.toolSubmit('gviewer')"/></td>
                                    <td align="center" ng-if="oKey==1 && (speciesTypeKey==1 || speciesTypeKey==3 || speciesTypeKey==6)"> <img src="<%= rgdBase %>/rgdweb/common/images/damaging.png" border="0" style="cursor:pointer;padding:5px; margin-right:0px; border:1px solid black;" ng-click="rgd.toolSubmit('damage')"/></td>
                                </tr>
                                <tr>
                                ...
                                <tr><td>&nbsp;</td></tr>
                                <tr>
                                    <td align="center" ng-if="oKey==1"> <img src="<%= rgdBase %>/rgdweb/common/images/annotCompare.png" border="0" style="cursor:pointer;padding:5px; margin-right:0px; border:1px solid black;" ng-click="rgd.toolSubmit('annotCompare')"/></td>
                                    <td align="center" ng-if="oKey==1"> <img src="<%= rgdBase %>/rgdweb/common/images/olga.png" border="0" style="cursor:pointer;padding:5px; margin-bottom:5px; border:1px solid black;" ng-click="rgd.toolSubmit('olga')"/></td>
                                    <td align="center"> <img src="<%= rgdBase %>/rgdweb/common/images/excel.png" border="0" style="cursor:pointer;padding:5px; margin-right:0px; border:1px solid black;" ng-click="rgd.toolSubmit('excel')"/></td>
                                </tr>
                                <tr>
                                ...
                                <tr><td>&nbsp;</td></tr>
                                <tr>
                                   <td align="center" ng-if="oKey==1"> <img src="<%= rgdBase %>/rgdweb/images/MOET.png" border="0" style="cursor:pointer;padding:5px; margin-bottom:5px; border:1px solid black;" ng-click="rgd.toolSubmit('enrichment')"/></td>
                                    <td align="center" ng-if="oKey==1"> <img src="<%= rgdBase %>/rgdweb/images/GOLF.png" border="0" style="cursor:pointer;padding:5px; margin-bottom:5px; border:1px solid black;" ng-click="rgd.toolSubmit('golf')"/></td>
                                </tr>
                                <tr>
